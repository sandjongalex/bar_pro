...
class ExchangeService:
    ...
    def create(
        ...
        The returned product can either be put back in stock or treated as
        non-resellable. The replacement always leaves stock. Any price
        difference is settled independently from the original sale.
        ...
        # IDs are useful in the immutable audit payload and also make the
        # replacement stock movement a stable audit target.
        db.session.flush()
